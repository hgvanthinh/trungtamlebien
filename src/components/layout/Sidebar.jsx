...
const Sidebar = ({ user, onLogout, onMenuItemClick }) => {
  ...
  const studentMenuItems = [
    ...
    { path: '/pig', icon: 'savings', label: 'Heo Đất', filled: true, badge: '🐷 Mới' },
    { path: '/versus', icon: 'swords', label: 'Đấu Trí 1v1', filled: true, badge: '⚔️ Mới' },
    { path: '/arena', icon: 'stadium', label: 'Đấu Trường', filled: true, badge: '🏟️ Mới' },
    { path: '/transfer', icon: 'send_money', label: 'Chuyển Xu/Vàng' },
  ...
  const adminMenuItems = [
    ...
    { path: '/admin/versus', icon: 'swords', label: 'Đấu Trí - Game', filled: true, badge: '⚔️' },
    { path: '/admin/arena', icon: 'stadium', label: 'Đấu Trường - Game', filled: true, badge: '🏟️' },
